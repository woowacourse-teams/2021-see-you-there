...
## request
include::{default-path}/board-read/http-request.adoc[]

## response
include::{default-path}/board-read/http-response.adoc[]

# 게시물 필터링해서 불러오기

## request
include::{default-path}/board-filter/http-request.adoc[]

## response
include::{default-path}/board-filter/http-response.adoc[]
